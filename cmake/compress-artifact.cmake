...
if( NOT DEFINED CMAKE_PROJECT_VERSION_MAJOR )
	message(FATAL_ERROR "Variable CMAKE_PROJECT_VERSION_MAJOR is not Defined")
endif()

if( NOT DEFINED CMAKE_PROJECT_VERSION_MINOR )
	message(FATAL_ERROR "Variable CMAKE_PROJECT_VERSION_MINOR is not Defined")
endif()

if( NOT DEFINED CMAKE_PROJECT_VERSION_PATCH )
	message(FATAL_ERROR "Variable CMAKE_PROJECT_VERSION_PATCH is not Defined")
endif()

if( NOT DEFINED CMAKE_PROJECT_VERSION_TWEAK )
	message(FATAL_ERROR "Variable CMAKE_PROJECT_VERSION_TWEAK is not Defined")
endif()

set(TARGET_ZIP "${PROJECT_NAME}_${CMAKE_PROJECT_VERSION_MAJOR}.${CMAKE_PROJECT_VERSION_MINOR}.${CMAKE_PROJECT_VERSION_PATCH}.${CMAKE_PROJECT_VERSION_TWEAK}.7z")
