...
namespace Drawer {
    ...
    void draw_arc(
        ...
        ImU32 color, uint32_t segments, const DrawArgs& a_drawArgs);

    void draw_arc_gradient(ImVec2 center, float radius_min, float radius_max,
                           float inner_ang_min, float inner_ang_max,
                           float outer_ang_min, float outer_ang_max,
                           ImU32 color_start, ImU32 color_end, uint32_t segments, const DrawArgs& a_drawArgs);

    void draw_circle_filled(const ImVec2& center, float radius, ImU32 color, int segments, const DrawArgs& a_drawArgs);

    void draw_triangle_filled(const ImVec2& p1, const ImVec2& p2, const ImVec2& p3, ImU32 col, const DrawArgs& a_drawArgs);
};  // namespace Drawer
