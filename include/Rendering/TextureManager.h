...
private:
    ...
    static bool load_texture_from_file(const char* filename, Image& a_image);

    template<typename T>
    static void load_images(std::map<std::string_view, T>& a_map,
    ...
    static inline std::string_view icon_directory{ R"(.\Data\SKSE\Plugins\Wheeler\resources\icons)" };
    static inline std::string_view img_directory{ R"(.\Data\SKSE\Plugins\Wheeler\resources\img)" };
    static inline std::string_view icon_custom_directory{ R"(.\Data\SKSE\Plugins\Wheeler\resources\icons_custom)" };

    inline static std::map<std::string_view, icon_image_type> icon_type_name_map{
        {               R"(potion_health.svg)",               icon_image_type::potion_health },
