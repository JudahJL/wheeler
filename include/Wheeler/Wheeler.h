...
public:
	...
	static void SerializeFromJsonObj(const nlohmann::json& j_wheeler, SKSE::SerializationInterface* a_intfc);
...
private:
	...
	static inline auto _state{ WheelState::KClosed };
	
	static inline bool _editMode{ false };

	static inline auto _wheelWindowID{ "##Wheeler" };
